        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
            <Link
              ...
              className="ck-button inline-flex items-center justify-center gap-2 bg-white text-black dark:bg-white dark:text-black px-6 py-3 md:px-8 md:py-4 rounded-full font-medium hover:bg-gray-100 transition group min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2"
            >
              Khám phá ngay
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-medium hover:bg-white hover:text-black transition min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2"
            >
              Góc tư vấn
            </Link>
          </div>
            ...
            >
              <div className="relative aspect-3/4 overflow-hidden rounded-lg mb-3 md:mb-4">
                ...
                <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 text-white">
                  ...
                  <span className="text-xs md:text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 block">
                    Khám phá ngay →
                  </span>
                </div>
              </div>
