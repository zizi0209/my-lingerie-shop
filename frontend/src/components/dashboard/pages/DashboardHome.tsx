  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-linear-to-br from-rose-500 to-pink-600 p-6 rounded-3xl text-white shadow-xl shadow-rose-200 dark:shadow-none relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="mt-8">
              ...
              <p className="text-rose-50 text-xs font-bold uppercase tracking-widest mt-1">Total Earning</p>
            </div>
          </div>
        </div>

        {/* Card 2: Total Order */}
        <div className="lg:col-span-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between overflow-hidden">
          <div className="flex justify-between items-start mb-4">
            <div className="p-2 bg-rose-50 dark:bg-rose-500/10 text-rose-500 rounded-xl">
              <ShoppingCart size={24} />
            </div>
            <div className="flex space-x-1">
              <button className="px-3 py-1 bg-rose-500 text-white text-[10px] font-black rounded-lg uppercase">Year</button>
              <button className="px-3 py-1 text-slate-400 text-[10px] font-black rounded-lg uppercase">Month</button>
            </div>
          </div>
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Total Orders</p>
            </div>
        ...
        {/* Card 3: Income Stats (Stacked) */}
        <div className="lg:col-span-4 flex flex-col gap-4">
          <div className="flex-1 bg-rose-500 p-4 rounded-3xl flex items-center space-x-4 text-white">
            <div className="p-2 bg-white/20 rounded-xl"><Package size={20} /></div>
            <div>
              <h4 className="font-black text-xl">$203k</h4>
              <p className="text-[10px] uppercase font-bold text-rose-100">Total Income</p>
            </div>
          </div>
          <div className="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-3xl flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500">Total Revenue</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Total Growth</p>
        ...
        <div className="lg:col-span-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Popular Pieces</h3>
          ...
          <div className="bg-rose-50 dark:bg-rose-500/5 rounded-2xl p-4 mb-6 border border-rose-100 dark:border-rose-500/10">
            <div className="flex justify-between items-start mb-2">
               <div>
                 <p className="text-xs font-bold text-rose-600 dark:text-rose-400">Bajaj Finery (Best Seller)</p>
                 <p className="text-[10px] text-rose-400">10% Profit Growth</p>
               </div>
