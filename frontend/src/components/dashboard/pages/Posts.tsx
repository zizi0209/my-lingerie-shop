  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-rose-500 hover:bg-rose-600 text-white px-4 py-2 rounded-xl font-bold flex items-center space-x-2 transition-all shadow-lg shadow-rose-200 dark:shadow-none active:scale-95"><Plus size={20}/><span>Create Post</span></button>
      </div>
